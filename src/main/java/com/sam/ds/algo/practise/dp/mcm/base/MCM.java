package com.sam.ds.algo.practise.dp.mcm.base;
/**
 * Given:   Either a String or Array
 *          Has to be broken in range i to k & k + 1 to j where i < k < j
 ...
 *          each element represent size of a matrix
 * Problem: Calculate M1*M2*M3....Mn s.t. Cost of Multiplication is minimum
 *          i.e. no of multiplications are minimum
 * */
public class MCM {
